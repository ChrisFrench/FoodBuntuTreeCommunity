...
class com_treetrackerInstallerScript
{
    public function preflight( $installation_type, $installer )
    {
    ...
    {
        $dscInstaller = new TreetrackerInstaller();
        if (!$dscInstaller->getLibrary())
        {
            ...
            foreach ($dscInstaller->getErrors() as $message)
            {
    ...
    public function update($installer)
    {
        ...
        {
            $thisextension = strtolower( "com_treetracker" );
...
class TreetrackerInstaller extends JObject
{
