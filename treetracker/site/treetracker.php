...
$options = array( 'site'=>'site', 'type'=>'components', 'ext'=>'com_treetracker' );

// Require the base controller
Treetracker::load( 'TreetrackerController', 'controller', $options );

// Require specific controller if requested
$controller = JRequest::getWord('controller', JRequest::getVar( 'view' ) );
if (!Treetracker::load( 'TreetrackerController'.$controller, "controllers.$controller", $options ))
    $controller = '';
