...
class Treetracker extends DSC
{
    protected $_name = 'treetracker';
    ...
    {
        $query = "SELECT * FROM #__treetracker_config";
        return $query;
    }
    ...
    {
        $cache = JFactory::getCache('com_treetracker.defines');
     ...
     *
     * Usage: $object = Treetracker::getClass( 'TreetrackerHelperCarts', 'helpers.carts' );
     * Usage: $suffix = Treetracker::getClass( 'TreetrackerHelperCarts', 'helpers.carts' )->getSuffix();
     * Usage: $categories = Treetracker::getClass( 'TreetrackerSelect', 'select' )->category( $selected );
     *
     ...
     */
    public static function getClass( $classname, $filepath='controller', $options=array( 'site'=>'admin', 'type'=>'components', 'ext'=>'com_treetracker' )  )
    {
     ...
     * @return boolean
     */
    public static function load( $classname, $filepath='controller', $options=array( 'site'=>'admin', 'type'=>'components', 'ext'=>'com_treetracker' ) )
    {
