...
Treetracker::load('TreetrackerModelBase','models.base');

class TreetrackerModelTools extends TreetrackerModelBase 
{	
    protected function _buildQueryWhere(&$query)
    {
		...
		$query->where("LOWER(tbl.folder) = 'treetracker'");
	...
	public function getList($refresh = false)
	{
		if ($list = parent::getList($refresh)) 
		{
		    ...
		    {
		        $item->link = 'index.php?option=com_treetracker&view=tools&task=view&id='.$item->id;
		    }		    
		} 
